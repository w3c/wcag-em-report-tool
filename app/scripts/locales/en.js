...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'INF_EXTRA_REQUIREMENTS': 'Define any additional evaluation requirements agreed with the evaluation commissioner. For more information, see {0}.',
