...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'INTRO_START_1': 'This tool helps you generate a report according to the {0}. It does not perform any accessibility checks. It helps you follow the steps of WCAG-EM, to generate a {1} from the input that you provide. It is designed for experienced evaluators who know {2} and are at least somewhat familiar with WCAG-EM. For an introduction to WCAG-EM, see the {3}.',
    ...
    'INTRO_START_2_HD': 'How it works in your browser',
    ...
    'INTRO_START_2_LI2A': 'This tool does not record or automatically save the information that you enter.',
    'INTRO_START_2_LI2B': 'Use the Save Report link that is at the top of all pages to save your data in a file locally on your computer. You can Save periodically as you work to avoid losing data if your browser closes.',
    'INTRO_START_2_LI3': 'You can save partially-complete reports and work on them later. Use the Open Report link at the top and find the file that you previously saved.',
    'INTRO_START_3_HD': 'Tips for using the tool',
    'INTRO_START_3_LI1': 'You can go back and forth between the steps in any order. None of the fields are required.',
    'INTRO_START_3_LI2A': 'To get more information about a field and a link to the specific section of WCAG-EM, select the ',
    ...
    'LABEL_PAGE': 'Address (URL) or description of how to get there',
    'LABEL_HANDLE': 'Short name',
    'LABEL_OUTCOME': 'Outcome',
    'LABEL_DESCR': 'Findings',
    'LABEL_TECH': 'Web Technology',
    'LABEL_TECH_SPEC': 'Specification Address (URL) or description',
    ...
    'INF_AUDIT_SAMPLE': 'This column lists all web pages selected in the previous step. You can select items to show them when \'show results for individual web pages\' is activated in the next column. This allows you show and hide individual web pages that you are evaluating, or several web pages at the same time.',
    ...
    'LEVEL_AA': 'Level AA',
    'LEVEL_AAA': 'Level AAA',
    'WARNING_BEFORE_UNLOAD': 'WARNING: WCAG-EM Report Tool does not automatically save your changes. If you want to save changes so you can continue later, save a local copy of the data using export',
    'BY': 'Report Creator:',
