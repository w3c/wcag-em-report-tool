...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'INTRO_START_2_LI2B': 'Use the Save Report link (Ctrl + C or ⌘ C) that is at the top of all pages to save your data in a file locally on your computer. You can Save periodically as you work to avoid losing data if your browser closes.',
    ...
    'INTRO_SAVE_1': 'The link below allows you to download and save the data of your current evaluation report locally on your own computer. This is useful to avoid losing data, or to transfer it to another computer or web browser session.',
