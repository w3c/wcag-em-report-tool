...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'HD_STRUCT_SAMPLE_SUB': 'Selected Web Pages (for editing)',
    ...
    'INTRO_STEP2': 'Explore the website to understand its purpose, functionality, and use. This steps helps you determine which web pages to use for the evaluation. You can come back and add web pages to this list later. Usually it is best to get input from the website owners and developers for this step. More guidance on this step is provided in {0}.',
    ...
    'INF_ESSENT_FUNC': 'Use this field to take notes about essential functionality of the website. These notes will be provided to you in the next step, so that you can select a sample of web pages based on these notes. Examples of essential functionality include:\n \'selecting and purchasing a product from the shop area of the website\'\n \'completing and submitting a form provided on the website\'\n \'registering for an account on the website\'\n For more information, see {0}.',
    'INF_ESSENT_FUNC_0': 'WCAG-EM Step 2.b: Identify Essential Functionality of the Website',
    'INF_VARIETY_PAGE_TYPES': 'Use this field to take notes about the types (as opposed to instances) of web pages that you find on the web site. This includes notes about varying styles, layouts, structures, and functionality provided on the website. These notes will be provided to you in the next step, so that you can select a sample of web pages based on these notes For more information, see {0}.\n Note: Web pages include different web page states; see definition of {1}.',
    ...
    'LEVEL_AA': 'Level AA',
    'LEVEL_AAA': 'Level AAA',
    'WARNING_BEFORE_UNLOAD': 'WARNING: The data you entered is not automatically saved. Use the \'Save\' link (Ctrl + S or ⌘ S) that is at the top of all pages to save your data in a file locally on your computer.',
    'BY': 'Report Creator:',
    'COMMISION_BY': 'Evaluation Commissioner:',
    'HD_ESSENT_FUNC': 'Essential functionality (from previous step)',
    'HD_VARIETY_PAGE_TYPES': 'Variety of web page types (from previous step)',
