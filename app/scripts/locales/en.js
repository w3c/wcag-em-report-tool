...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'HD_LOAD': 'Load The Evaluation',
    'HD_SAVE': 'Save A Local Copy',
    ...
    'INTRO_SAVE': 'INTRO SAVE',
    'INTRO_LOAD': 'INTRO LOAD',
    ...
    'BTN_EXPAND_PAGES': 'Show results for individual pages',
    'BTN_COLLAPSE_PAGES': 'Hide  results for individual pages',
    'BTN_LOAD_FILE': 'Load the file',
    'BTN_DOWNLOAD_DATA_FILE': 'Download the file',
    'BTN_BACK_TO_EVAL': 'Back to the evaluation',
