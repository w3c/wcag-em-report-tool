...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'CONFIRM_TRANSFER_MACRO_RESULT': 'Merging macro results into pages can not be undone. Continue?',
    'YES': 'Yes',
    'NO': 'No',
    ...
    'BTN_REMOVE_MACRO_ASSERT': 'Remove macro result',
    'BTN_ADD_MACRO_ASSERT': 'Add macro result',
    'BTN_TRANSFER_MACRO_ASSERT': 'Merge macro result into page results',
    ...
    'INTRO_START_2': 'Following the steps of WCAG-EM and using this tool to carry out a comprehensive accessibility evaluation of a website requires experience in evaluating accessibility using the {0}. WCAG-EM provides further guidance on background reading, and users of this tool are expected to be familiar with WCAG-EM. Also, efore evaluating an entire website it is usually good to do a preliminary evaluation of different web pages from the target website to identify obvious accessibility barriers and develop an overall understanding of the accessibility of the website. {1} describes such an approach for preliminary evaluation that is complementary to WCAG-EM.',
