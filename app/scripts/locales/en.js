...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'INTRO_START_1': 'This tool helps you generate a report according to the {0}. It does not perform any accessibility checks. It helps you follow the steps of WCAG-EM, to generate a {1} from the input that you provide.',
    'INTRO_START_1_0': 'Website Accessibility Conformance Evaluation Methodology (WCAG-EM)',
    'INTRO_START_1_1': 'structured report',
    'INTRO_START_2_HD': 'Background knowledge',
    'INTRO_START_2': 'This tool is designed for experienced evaluators who know {0} and are at least somewhat familiar with WCAG-EM. For an introduction to WCAG-EM, see the {1}.',
    'INTRO_START_2_0': 'Web Content Accessibility Guidelines (WCAG) 2.0',
    'INTRO_START_2_1': 'WCAG-EM Overview',
    'INTRO_START_3': 'If you do not know much about web accessibility or evaluation and you want to get an initial idea of the accessibility of a web page, you can follow {0}.',
    'INTRO_START_3_0': 'Easy Checks - A First Review of Web Accessibility',
    'INTRO_START_4_HD': 'How it works in your browser',
    'INTRO_START_4_LI1': 'All functionality provided by this tool is now loaded and running locally in your web browser. You don\'t need an Internet connection beyond this point. When you close your browser window, any unsaved data would be lost.',
    'INTRO_START_4_LI2A': 'This tool does not record or automatically save the information that you enter.',
    'INTRO_START_4_LI2B': 'Use the Save Report link that is at the top of all pages to save your data in a file locally on your computer. You can Save periodically as you work to avoid losing data if your browser closes.',
    'INTRO_START_4_LI3': 'You can save partially-complete reports and work on them later. Use the Open Report link at the top and find the file that you previously saved.',
    'INTRO_START_5_HD': 'Tips for using the tool',
    'INTRO_START_5_LI1': 'You can go back and forth between the steps in any order. None of the fields are required.',
    'INTRO_START_5_LI2A': 'To get more information about a field and a link to the specific section of WCAG-EM, select the ',
    'INTRO_START_5_LI2B': ' icon next to the field label.',
    'INTRO_START_5_LI3': 'You can download the report with your input as an HTML file and customize it.',
    'INTRO_STEP1': 'Define the overall parameters and scope of the evaluation. Ideally, this is done with the person who commissioned the evaluation (who may or may not be the website owner), to ensure common expectations about the scope of the evaluation.',
    'INTRO_STEP2': 'Explore the website to understand its purpose, functionality, and use. This steps helps you determine which web pages to use for the evaluation. You can come back and add web pages to this list later. Usually it is best to get input from the website owners and developers for this step.',
    ...
    'INF_COMMON_PAGES': 'Identify web pages that are relevant to the entire website. Examples of other relevant web pages include those that explain the accessibility features of the website; help for using the website; explanations for settings, preferences, options, and shortcuts; and contact information. For more information, see {0}.',
