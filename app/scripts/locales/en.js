...
angular.module('wcagReporter').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'PLH_HANDLE': 'Handler to identify the page',
    'PLH_PAGE_URL': 'URL or description of the page location',
    'PLH_TECH': 'Name of the technology',
    'PLH_TECH_SPEC': 'URI for the technology\'s specification',
