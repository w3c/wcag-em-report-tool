 ...
 */
angular.module('wcagReporter').factory('wcag20spec', function() {
    return [{
      "number": "1",
      "title": "Perceivable",
      "uri": "#perceivable",
      ...
      "guidelines": [{
        ...
        "criteria": [{
          ...
          "title": "Captions (Live)",
          "level": "AA",
          "uri": "#media-equiv-real-time-captions",
          ...
          "level": "AA",
          "uri": "#media-equiv-audio-desc-only",
          ...
          "level": "AAA",
          "uri": "#media-equiv-live-audio-only",
        ...
        "number": "1.3",
        "title": "Adaptable",
        "uri": "#content-structure-separation",
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "1.3.1",
          "uri": "#content-structure-separation-programmatic"
        }, {
          ...
          "specific_cases": [],
          "number": "1.3.2",
          "uri": "#content-structure-separation-sequence"
        }, {
          ...
          "specific_cases": [],
          "number": "1.3.3",
          "uri": "#content-structure-separation-understanding"
        }]
      }, {
        "number": "1.4",
        "title": "Distinguishable",
        "uri": "#visual-audio-contrast",
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "1.4.1",
          "uri": "#visual-audio-contrast-without-color"
        }, {
          "title": "Audio Control",
          ...
          "specific_cases": [],
          "number": "1.4.2",
          "uri": "#visual-audio-contrast-dis-audio"
        }, {
          ...
          "specific_cases": [],
          "number": "1.4.4",
          "uri": "#visual-audio-contrast-scale"
        }, {
          ...
          "number": "1.4.5",
          "uri": "#visual-audio-contrast-text-presentation"
        }, {
          ...
          "specific_cases": [{
            ...
            "title": "20 dB",
            "description": "The background sounds are at least 20 decibels lower than the foreground speech content, with the exception of occasional sounds that last for only one or two seconds.Note"
          }],
          "number": "1.4.7",
          "uri": "#visual-audio-contrast-noaudio"
        }, {
          ...
          "specific_cases": [],
          "number": "1.4.8",
          "uri": "#visual-audio-contrast-visual-presentation"
        }, {
          ...
          "specific_cases": [],
          "number": "1.4.9",
          "uri": "#visual-audio-contrast-text-images"
        }]
      }]
    }, {
      "number": "2",
      ...
      "guidelines": [{
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "2.1.1",
          "uri": "#keyboard-operation-keyboard-operable"
        }, {
          ...
          "specific_cases": [],
          "number": "2.1.2",
          "uri": "#keyboard-operation-trapping"
        }, {
          ...
          "specific_cases": [],
          "number": "2.1.3",
          "uri": "#keyboard-operation-all-funcs"
        }],
        "uri": "#keyboard-operation"
      }, {
        "title": "Enough Time",
        ...
        "criteria": [{
          ...
          "number": "2.2.1",
          "uri": "#time-limits-required-behaviors"
        }, {
          ...
          "specific_cases": [],
          "number": "2.2.5",
          "uri": "#time-limits-server-timeout"
        }],
        "uri": "#time-limits"
      }, {
        "title": "Seizures",
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "2.4.1",
          "uri": "#navigation-mechanisms-skip"
        }, {
          "title": "Page Titled",
          ...
          "specific_cases": [],
          "number": "2.4.2",
          "uri": "#navigation-mechanisms-title"
        }, {
          "title": "Focus Order",
          ...
          "specific_cases": [],
          "number": "2.4.3",
          "uri": "#navigation-mechanisms-focus-order"
        }, {
          ...
          "specific_cases": [],
          "number": "2.4.4",
          "uri": "#navigation-mechanisms-refs"
        }, {
          "title": "Multiple Ways",
          ...
          "specific_cases": [],
          "number": "2.4.5",
          "uri": "#navigation-mechanisms-mult-loc"
        }, {
          ...
          "specific_cases": [],
          "number": "2.4.6",
          "uri": "#navigation-mechanisms-descriptive"
        }, {
          "title": "Focus Visible",
          ...
          "specific_cases": [],
          "number": "2.4.7",
          "uri": "#navigation-mechanisms-focus-visible"
        }, {
          "title": "Location",
          ...
          "specific_cases": [],
          "number": "2.4.8",
          "uri": "#navigation-mechanisms-location"
        }, {
          ...
          "specific_cases": [],
          "number": "2.4.9",
          "uri": "#navigation-mechanisms-link"
        }, {
          ...
          "specific_cases": [],
          "number": "2.4.10",
          "uri": "#navigation-mechanisms-headings"
        }],
        "uri": "#navigation-mechanisms"
      }]
    }, {
      "number": "3",
      ...
      "guidelines": [{
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "3.2.1",
          "uri": "#consistent-behavior-receive-focus"
        }, {
          "title": "On Input",
          ...
          "specific_cases": [],
          "number": "3.2.2",
          "uri": "#consistent-behavior-unpredictable-change"
        }, {
          "number": "3.2.3",
          "title": "Consistent Navigation",
          "level": "AA",
          "uri": "#consistent-behavior-consistent-locations",
          ...
          "level": "AA",
          "uri": "#consistent-behavior-consistent-functionality",
          ...
          "level": "AAA",
          "uri": "#consistent-behavior-no-extreme-changes-context",
        ...
        "criteria": [{
          ...
          "specific_cases": [],
          "number": "3.3.3",
          "uri": "#minimize-error-suggestions"
        }, {
          ...
          "specific_cases": [],
          "number": "3.3.5",
          "uri": "#minimize-error-context-help"
        }, {
          ...
          "specific_cases": [],
          "number": "3.3.6",
          "uri": "#minimize-error-reversible-all"
        }]
      }]
    }, {
      "number": "4",
      ...
      "guidelines": [{
        ...
        "criteria": [{
          ...
          "level": "A",
          "specific_cases": [],
          "uri": "#ensure-compat-parses"
        }, {
          "number": "4.1.2",
          "title": "Name, Role, Value",
          "description": "For all user interface components (including but not limited to",
          "level": "A",
          "specific_cases": [],
          "uri": "#ensure-compat-rsv"
        }]
      }]
    }];
});
