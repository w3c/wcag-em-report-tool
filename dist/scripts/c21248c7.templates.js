...
'\n' +
'  <label for="show_version_21" class="btn" ng-class="{\n' +
'    \'btn-primary\': critFilter[\'WCAG21\'],\n' +
'    \'btn-primary-invert\': !critFilter[\'WCAG21\']\n' +
'  }">\n' +
'    <input id="show_version_21" type="checkbox" ng-model="critFilter[\'WCAG21\']">\n' +
'    {{ \'SCOPE.WCAG21\' | translate}}\n' +
'  </label>\n' +
'\n' +
'  <label for="show_version_20" class="btn" ng-class="{\n' +
'    \'btn-primary\': critFilter[\'WCAG20\'],\n' +
'    \'btn-primary-invert\': !critFilter[\'WCAG20\']\n' +
'  }">\n' +
'    <input id="show_version_20" type="checkbox" ng-model="critFilter[\'WCAG20\']">\n' +
'    {{ \'SCOPE.WCAG20\' | translate}}\n' +
'  </label>\n' +
'\n' +
