...
<footer lang="en" class="page-footer">
  <div>
    <p>
      <strong>Feedback: We welcome ideas, bug reports, and comments</strong>
      via
      <a href="https://github.com/w3c/wcag-em-report-tool/issues">GitHub</a>
      or e-mail to
      <a href="mailto:wai-eo-editors@w3.org">wai-eo-editors@w3.org</a>
      (a publicly archived list) or
      <a href="mailto:wai@w3.org">wai@w3.org</a>
    ...
    <p>
      ...
      Shadi Abou-Zahra, W3C/WAI (Project Lead) and Roel Antonisse,
      <a href="https://www.accessibility.nl/english">accessibility.nl</a>
      (Development). Previously Wilco Fiers (Design and development).
      <strong>Contributors:</strong>
      <a href="http://www.w3.org/People/Shawn/">Shawn Lawton Henry</a>
      and the
      <a href="http://www.w3.org/WAI/EO/">Education and Outreach Working Group</a>.</p>
    <p>Initially developed with support from the
    ...
    <div class="copyright">
      <p>
        ...
        <a href="/Consortium/Legal/ipr-notice">Usage policies apply</a>.</p>
    </div>
    <!-- ends copyright -->
  </div>
</footer>
